...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            edge->SetChildNode( (*childNode).get() ); // note order of ops * called last
                            edge->SetParentNode( (*parentNode).get());  // note order of ops * called last
    ...
    std::unique_ptr<ChatBot> uChatBot {_chatBot};

    rootNode->MoveChatbotHere(std::move(uChatBot));
